...
try {
    ...
    function toggleFullscreen(event) {
        ...
        if (!document.fullscreenElement &&    // alternative standard method
            ...
            c1.removeEventListener("mousedown", toggleFullscreen);
        }
        //}
    ...
    function updateTime() {
        ...
        dateStr += (month + 1).toString()  + "-" + year.toString() ;
    ...
    function draw() {
        try {
            ...
            ctx1.fillText(dateStr, (w * config_datex) - (dateWidth * 1.0) + 222, (h * config_datey));
            ctx1.closePath();
            ctx1.beginPath(); // Time
            ...
            ctx1.fillText(timeStr, (w * config_timex) - (timeWidth * 1.0) + 200, (h * config_timey));
            ctx1.closePath();
